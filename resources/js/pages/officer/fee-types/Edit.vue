...
const { feeType } = defineProps<Props>();
...
<template>
    ...
    <div class="flex flex-col space-y-6 p-4">
        <Heading
            :title="feeType.name"
            description="Changing the amount does not rewrite Charges already levied."
        />

        <Form
            v-bind="FeeTypeController.update.form(feeType)"
